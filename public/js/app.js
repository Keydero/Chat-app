...
new Vue({
    ...
    methods: {
        notify: function notify(username) {
            this.$notify({
        ...
        send: function send() {
            ...
            axios.post('send', this.$data).then(function (response) {
                return _this.msg = '';
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_notification__ = __webpack_require__(15);
